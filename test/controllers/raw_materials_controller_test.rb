...
class RawMaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create raw_material" do
    assert_difference('RawMaterial.count') do
      post raw_materials_url, params: { raw_material: { description: @raw_material.description, name: @raw_material.name, qty: @raw_material.qty, unit: @raw_material.unit } }
    end
  ...
  test "should update raw_material" do
    patch raw_material_url(@raw_material), params: { raw_material: { description: @raw_material.description, name: @raw_material.name, qty: @raw_material.qty, unit: @raw_material.unit } }
