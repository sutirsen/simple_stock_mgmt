...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { is_active: @tax.is_active, name: @tax.name, perc: @tax.perc } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { is_active: @tax.is_active, name: @tax.name, perc: @tax.perc } }
